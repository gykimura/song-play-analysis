...
def process_log_file(cur, filepath):
    """
    - Loads and processes log file.
    - Inserts processed data into time, users and songplays tables.  
    """
    # open log file
    df = pd.read_json(filepath, lines=True)  
...
def process_data(cur, conn, filepath, func):
    """
    Processes all the files in the data directory and creates Postgres tables
    """
